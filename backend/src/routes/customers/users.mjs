...
users.post(
  ...
  [
    ...
    body("password").matches(passwordRegEx).withMessage("Password must be at least 8 characters long, contain at least one uppercase letter, one lowercase letter, and one digit"),
